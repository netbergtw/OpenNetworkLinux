...
class OnlPlatform_x86_64_netberg_aurora_610_r0(OnlPlatformNetberg,
	...
	# init SFP28 EEPROM
        ...
        subprocess.call('echo port50 > /sys/bus/i2c/devices/58-0050/port_name', shell=True)
        subprocess.call('echo port49 > /sys/bus/i2c/devices/59-0050/port_name', shell=True)
        subprocess.call('echo port52 > /sys/bus/i2c/devices/60-0050/port_name', shell=True)
        subprocess.call('echo port51 > /sys/bus/i2c/devices/61-0050/port_name', shell=True)
        subprocess.call('echo port54 > /sys/bus/i2c/devices/62-0050/port_name', shell=True)
        subprocess.call('echo port53 > /sys/bus/i2c/devices/63-0050/port_name', shell=True)
        subprocess.call('echo port56 > /sys/bus/i2c/devices/64-0050/port_name', shell=True)
        subprocess.call('echo port55 > /sys/bus/i2c/devices/65-0050/port_name', shell=True)
