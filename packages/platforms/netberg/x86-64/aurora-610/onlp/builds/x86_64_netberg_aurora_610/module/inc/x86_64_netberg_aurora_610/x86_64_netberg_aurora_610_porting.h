...
#ifndef x86_64_netberg_aurora_610_STRNCPY
    #if defined(GLOBAL_STRNCPY)
        #define x86_64_netberg_aurora_610_STRNCPY GLOBAL_STRNCPY
    #elif x86_64_netberg_aurora_610_CONFIG_PORTING_STDLIB == 1
        #define x86_64_netberg_aurora_610_STRNCPY strncpy
    #else
        #error The macro x86_64_netberg_aurora_610_STRNCPY is required but cannot be defined.
    #endif
#endif
